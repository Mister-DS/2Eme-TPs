...
photo = PhotoImage(file='C:\Users\simon\OneDrive - EPHEC asbl\2eme\Q1\Dev TP\Projet_DevII\img\table_restau.jpeg')
label = Label(fenetre, image=photo)
photo = photo.resize((300, 300))


image_bouton = Button(fenetre, command=image_click)
image_bouton.pack()
